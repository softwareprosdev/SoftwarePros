          ...
          <div className="md:col-span-1">
            <div className="mb-6">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Professional software development, consulting, and digital solutions for startups
                and enterprises. Built by experts. Trusted by businesses worldwide.
              </p>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-400 text-sm">(956) 357-5588</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-400 text-sm">
                © {currentYear} SoftwarePros. All rights reserved.
              </p>
