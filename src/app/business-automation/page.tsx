...
const automationServices: AutomationService[] = [
  ...
  },
  {
    ...
    description:
      "Connect all your business tools so data flows automatically between systems.",
    benefits: [
  ...
  },
  {
    ...
    description:
      "Custom admin panels that give your team the tools they need to work efficiently.",
    benefits: [
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">
            Stop wasting time on manual tasks. We build custom automation software that
            eliminates repetitive work, reduces errors, and lets your team focus on
            what matters most.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
            From simple task automation to complex multi-system workflows, we build
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                title: "Design",
                description:
                  "We design a custom solution that fits your exact business processes.",
              },
              {
                step: "3",
                title: "Build",
                description:
                  "We develop and test your automation with continuous feedback loops.",
              },
              {
                step: "4",
                title: "Deploy",
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">
            ...
            could save with custom business automation software.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
